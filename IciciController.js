...
const newCsv = require('./newCsv');
 function IciciController(inputFile,outputFile)
{
    ...
    .on('data', (row) => {
        ...
        if(row.Debit=="International Transaction")
        {
            // console.log("yooooooo")
            zone="International"
            Person="";
        }
        else if(row.Debit==="Rahul"|| row.Debit==="Ritu"||row.Debit=="Raj")
            Person=row.Debit;
        if(Person!=="")
        {
...
module.exports=IciciController;